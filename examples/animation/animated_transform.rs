...
fn setup(
    ...
    animation.add_curve_to_target(
        ...
        VariableCurve {
            ...
            keyframes: Box::new(AnimatablePropertyKeyframes::<Translation>(vec![
    ...
    animation.add_curve_to_target(
        ...
        VariableCurve {
            keyframe_timestamps: vec![0.0, 1.0, 2.0, 3.0, 4.0],
            keyframes: Box::new(AnimatablePropertyKeyframes::<Rotation>(vec![
                Quat::IDENTITY,
    ...
    animation.add_curve_to_target(
        ...
        VariableCurve {
            ...
            keyframes: Box::new(AnimatablePropertyKeyframes::<Scale>(vec![
                Vec3::splat(0.8),
                Vec3::splat(1.2),
                Vec3::splat(0.8),
                Vec3::splat(1.2),
