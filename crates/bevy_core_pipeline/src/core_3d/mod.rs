...
pub fn extract_camera_prepass_phase(
    ...
    ) in cameras_3d.iter()
    {
        ...
        if depth_prepass || normal_prepass || motion_vector_prepass {
            opaque_3d_prepass_phases.prepare_for_new_frame(retained_view_entity, gpu_preprocessing_mode);
        ...
        if deferred_prepass {
            opaque_3d_deferred_phases.prepare_for_new_frame(retained_view_entity, gpu_preprocessing_mode);
