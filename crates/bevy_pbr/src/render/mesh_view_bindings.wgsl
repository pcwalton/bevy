...
@group(0) @binding(6) var<storage> clusterables: types::Clusterables;
@group(0) @binding(7) var<storage> cluster_index_lists: types::ClusterIndexLists;
@group(0) @binding(8) var<storage> cluster_offsets_and_counts: types::ClusterOffsetsAndCounts;
#else
@group(0) @binding(6) var<uniform> clusterables: types::Clusterables;
@group(0) @binding(7) var<uniform> cluster_index_lists: types::ClusterIndexLists;
