...
@group(0) @binding(23) var<storage> decals: types::Decals;
@group(0) @binding(24) var decal_textures: binding_array<texture_2d<f32>, 8u>;
@group(0) @binding(25) var decal_sampler: sampler;
