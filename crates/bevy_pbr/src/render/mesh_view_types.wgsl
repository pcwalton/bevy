...
struct PointLight {
    // The lower-right 2x2 values of the projection matrix [2][2] [2][3] [3][2] [3][3]
    projection_matrix_lower_right: mat2x2<f32>,
...
const POINT_LIGHT_FLAGS_SHADOWS_ENABLED_BIT: u32    = 1u << 0;

const SPOT_LIGHT_FLAGS_SHADOWS_ENABLED_BIT: u32     = 1u << 0;
const SPOT_LIGHT_FLAGS_Y_NEGATIVE_BIT: u32          = 1u << 1;
...
struct Clusterables {
    data: array<Clusterable>,
};
struct ClusterIndexLists {
    data: array<u32>,
};
