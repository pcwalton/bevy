...
#import bevy_pbr::pbr_types::StandardMaterialBindlessIndices

fn sample_depth_map(
    uv: vec2<f32>,
#ifdef BINDLESS_TEXTURES
    bindless_indices: ptr<function, StandardMaterialBindlessIndices>,
...
#ifdef BINDLESS_TEXTURES
        depth_map_texture[(*bindless_indices).depth_map_texture],
        depth_map_sampler[(*bindless_indices).depth_map_sampler],
