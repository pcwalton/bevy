    ...
    E: UiRenderObject,
{
    ...
    fn render<'w>(
        ...
        // Draw directly or indirectly, as appropriate. If we're drawing
        // indirectly, we can issue a single multi-draw call with an entire
        // range of batches, we might have to issue multiple drawcalls, one for
        // each batch.
