use crate::physics::{
    ColliderBundle, ColliderChangesQueryFilter, ColliderChangesQueryPayload,
    ColliderComponentsSet, IntoEntity, IntoHandle, JointHandleComponent,
    RigidBodyChangesQueryFilter, RigidBodyChangesQueryPayload, RigidBodyComponentsSet,
};
    ...
    UserData: WorldQuery,
{
    ...
    fn modify_solver_contacts<'world, 'state, 'a>(
        &self,
...
impl<'a, 'b, UserData: WorldQuery>
    PhysicsHooks<RigidBodyComponentsSet<'_, '_, 'a>, ColliderComponentsSet<'_, '_, 'b>>
    for PhysicsHooksWithQueryInstance<'_, '_, '_, UserData>
{
    fn filter_contact_pair(
        &self,
        context: &PairFilterContext<
            RigidBodyComponentsSet<'_, '_, 'a>,
            ColliderComponentsSet<'_, '_, 'b>,
        >,
    ) -> Option<SolverFlags> {
